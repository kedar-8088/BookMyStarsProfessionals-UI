    ...
    return (
        <Box sx={{ mt: 4 }}>
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    <MainCard title="Hiring Talent Dashboard">
                        <Typography variant="body1" color="textSecondary" sx={{ mb: 3 }}>
                            Manage all hiring talent accounts, verifications, and settings from this centralized dashboard.
                        </Typography>
                    </MainCard>
                </Grid>
                    ...
                    <MainCard title="Quick Actions">
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={6} md={3}>
                                ...
                                >
                                    <Typography variant="h6">View All Hiring Talents</Typography>
                                </Card>
                            </Grid>
                            <Grid item xs={12} sm={6} md={3}>
                                <Card
...
export default HiringTalentManagement;
