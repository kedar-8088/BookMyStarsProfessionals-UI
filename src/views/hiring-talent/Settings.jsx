    ...
    return (
        <Box sx={{ mt: 4 }}>
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    <MainCard title="Hiring Talent Settings">
                        <Typography variant="body1" color="textSecondary" sx={{ mb: 3 }}>
                            Configure hiring talent management settings, approval processes, and system preferences.
                        </Typography>
                    </MainCard>
                </Grid>
                    ...
                    <MainCard title="Approval Settings">
                        <Box sx={{ mb: 3 }}>
                            <FormControlLabel
                                ...
                                label="Auto-approve hiring talents"
                            />
                            <Typography variant="body2" color="textSecondary" sx={{ ml: 4, mt: 1 }}>
                                Automatically approve hiring talents without manual review
                            </Typography>
                        </Box>
                        ...
                        <Box sx={{ mb: 3 }}>
                            ...
                            />
                            <Typography variant="body2" color="textSecondary" sx={{ ml: 4, mt: 1 }}>
                                Require document verification for all hiring talents
                            </Typography>
                        </Box>
                        ...
                        <Box sx={{ mb: 3 }}>
                            <TextField
                                fullWidth
                                label="Maximum Hiring Talents"
                                type="number"
                                value={settings.maxHiringTalents}
                                onChange={handleSettingChange('maxHiringTalents')}
                                helperText="Maximum number of hiring talents allowed in the system"
                            />
                        </Box>
                    </MainCard>
                </Grid>
                    ...
                    <MainCard title="Notification Settings">
                        ...
                        <Box sx={{ mb: 3 }}>
                            ...
                            <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                                <Typography variant="body2">Total Hiring Talents:</Typography>
