    ...
    return (
        <Box sx={{ mt: 4 }}>
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    <MainCard title="Hiring Talent Verification Management">
                        <Typography variant="body1" color="textSecondary" sx={{ mb: 3 }}>
                            Review and manage hiring talent verification applications. Approve or reject applications based on submitted
                    ...
                    <MainCard title="Recent Verification Applications">
                        <TableContainer component={Paper} sx={{ boxShadow: 'none' }}>
                            <Table>
                                <TableHead>
                                    <TableRow>
                                        <TableCell>Hiring Talent</TableCell>
