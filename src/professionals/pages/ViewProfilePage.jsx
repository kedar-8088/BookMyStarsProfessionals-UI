      ...
      {!loading && !error && profileData && (
        <>
          ...
          <Box className="print-content" sx={{ py: 2, backgroundColor: 'white', minHeight: '100vh' }}>
            ...
            {/* Rest of the profile sections - keeping same structure but removing edit buttons */}
            ...
            <Box sx={{ px: { xs: 2, sm: 3, md: 4 }, mt: 4, maxWidth: '1200px', mx: 'auto' }}>
              ...
              {/* Videos Section */}
              <Box sx={{ mb: 4 }}>
                <Typography sx={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: '18px', lineHeight: '140%', color: '#DA498D', mb: 2 }}>
                  Videos
                </Typography>
              ...
              {/* Photos and Social Media Section */}
              ...
              {/* Skills Section */}
              <Box sx={{ mt: 4 }}>
                <Typography sx={{ fontFamily: 'Poppins', fontWeight: 600, fontSize: '18px', lineHeight: '140%', color: '#DA498D', mb: 3 }}>
                  Skills
                </Typography>
                ...
                <Box sx={{ display: 'flex', gap: 3, flexWrap: 'wrap', mb: 4 }}>
                  {profileData.workExperiences?.map((experience, index) => (
                    <Box key={experience.id} sx={{ flex: 1, minWidth: '300px' }}>
                      <Box sx={{ border: '1px solid', borderImage: 'linear-gradient(90deg, #DA498D 0%, #69247C 100%) 1', borderRadius: '8px', p: 3, backgroundColor: 'white' }}>
                        {[
            ...
            {/* Print Button - Bottom */}
            <Box className="no-print" sx={{ display: 'flex', gap: 3, justifyContent: 'center', mt: 6, mb: 4 }}>
              <Button 
                variant="contained" 
                onClick={handlePrint}
                startIcon={<PrintIcon />}
