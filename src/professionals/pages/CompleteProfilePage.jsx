...
const CompleteProfilePage = () => {
  ...
  const handleShareProfile = async () => {
    ...
    // Use shared profile URL format: /profile/:profileId
    const currentUrl = `${window.location.origin}/profile/${profileId}`;
    ...
    if (navigator.share) {
      try {
        ...
        // User cancelled or error occurred, fall through to show options
    ...
    // Try to copy to clipboard first (primary action)
    try {
      ...
      Swal.fire({
        ...
        html: `
          <div style="text-align: center; padding: 10px 0;">
            <p style="margin-bottom: 15px;">Profile link has been copied to your clipboard.</p>
            <div style="background: #f5f5f5; padding: 10px; border-radius: 8px; word-break: break-all; font-size: 12px; color: #666;">
              ${currentUrl}
            </div>
            <p style="margin-top: 15px; font-size: 14px; color: #666;">Share on social media:</p>
          </div>
          <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 15px;">
            <a href="https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(currentUrl)}" 
               ...
               onclick="Swal.close()"
               style="display: flex; align-items: center; gap: 10px; padding: 10px; background: #1877F2; color: white; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 14px;">
            ...
            <a href="https://twitter.com/intent/tweet?text=${encodeURIComponent(shareText)}&url=${encodeURIComponent(currentUrl)}" 
               ...
               rel="noopener noreferrer"
               onclick="Swal.close()"
               style="display: flex; align-items: center; gap: 10px; padding: 10px; background: #1DA1F2; color: white; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 14px;">
              <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
            ...
            <a href="https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(currentUrl)}" 
               ...
               rel="noopener noreferrer"
               onclick="Swal.close()"
               style="display: flex; align-items: center; gap: 10px; padding: 10px; background: #0077B5; color: white; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 14px;">
              <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
            ...
            <a href="https://wa.me/?text=${encodeURIComponent(shareText + ' ' + currentUrl)}" 
               ...
               rel="noopener noreferrer"
               onclick="Swal.close()"
               style="display: flex; align-items: center; gap: 10px; padding: 10px; background: #25D366; color: white; border-radius: 8px; text-decoration: none; font-weight: 500; font-size: 14px;">
              <svg width="20" height="20" fill="white" viewBox="0 0 24 24">
      ...
      // Clipboard API not available or failed, show sharing options
      console.error('Failed to copy to clipboard:', err);
      Swal.fire({
        title: 'Share Profile',
        html: `
          <div style="display: flex; flex-direction: column; gap: 12px; margin-top: 20px;">
            <div style="background: #f5f5f5; padding: 12px; border-radius: 8px; word-break: break-all; font-size: 12px; color: #666; margin-bottom: 10px;">
              ${currentUrl}
            </div>
